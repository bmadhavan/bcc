...
"""
    ...
    def test_attach1(self):
        ...
        # note that event4 does not really fire, so its state should be 0
        self.assertTrue(self.evt_st_1 == 1 and self.evt_st_2 == 1 and
                        self.evt_st_3 == 1 and self.evt_st_4 == 0 and
                        self.evt_st_5 == 1 and self.evt_st_6 == 1)
